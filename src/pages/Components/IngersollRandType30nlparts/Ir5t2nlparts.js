...
const cardData = [
  {
    ...
    alt: ' Air Inlet Filter IR 5T2 NL Air Compressor Parts',
    heading: ' Air Inlet Filter IR 5T2 NL Air Compressor Parts',
  ...
  },
  {
    ...
    alt: ' Ingersoll Rand 5T2 NL Air Compressor Parts ',
    heading: 'Ingersoll Rand 5T2 NL Air Compressor Parts',
  },
  {
    ...
    alt: ' Intercooler IR 5T2 NL Air Compressor Parts',
    heading: ' Intercooler IR 5T2 NL Air Compressor Parts ',
  },

  {
    ...
    alt: " Overhaul Kit IR 5T2 NL Replacement",
    heading: ' Overhaul Kit IR 5T2 NL Replacement',
  ...
  },
  {
    ...
    alt: "Bare Compressor IR 5T2 NL Air Compressor Parts",
    heading: "Bare Compressor IR 5T2 NL Air Compressor Parts",
  ...
  },
  {
    ...
    alt: ' 5" Piston, Cylinder & Crosshead IR 5T2 NL Parts',
    heading: ' 5" Piston, Cylinder & Crosshead IR 5T2 NL Parts',

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt: ' Compressor Frame IR 5T2 NL Air Compressor Parts  ',
    heading: " Compressor Frame IR 5T2 NL Air Compressor Parts ",

  },

  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt: 'Tube Assemblies & Fittings IR 5T2 NL Parts',
    heading: "Tube Assemblies & Fittings IR 5T2 NL Parts",

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt: ' HP Concentric Ring Valve IR 5T2 NL Parts  ',
    heading: " HP Concentric Ring Valve IR 5T2 NL Parts ",

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt: '  LP Concentric Ring Valve IR 5T2 NL Parts  ',
    heading: "  LP Concentric Ring Valve IR 5T2 NL Parts ",

  },
  {
  image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
  alt: ' 3" Piston, Cylinder & Crosshead IR 5T2 NL Parts  ',
  heading: ' 3" Piston, Cylinder & Crosshead IR 5T2 NL Parts',

},
{
  image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
  alt: ' Bushing, Crankpin 37002367 Replacement  ',
  heading: 'Bushing, Crankpin 37002367 Replacement',
  ...
  return (
    ...
    <Grid className="home-container-page">
      ...
      <Grid item xs={12} className="home-page-textf">
        <h1><u>IR 5T2NL  Parts</u></h1>
        <Grid item xs={12} md={6} className="mt-5">
          Ingersoll Rand 5T2NL Air Compressor Parts - Ingersoll Rand Type 30 NL Parts - Air Compressor Spare Parts.
        </Grid>

        <Grid item xs={12} md={6} className="mt-4">
          PFC - Parts for compressor is a global supplier of OEM Quality New Aftermarket Replacement Air Compressor Spare Parts - Ingersoll Rand 5T2NL Air Compressor Parts - Ingersoll Rand Type 30 NL Parts from India.
        </Grid>
      </Grid>
