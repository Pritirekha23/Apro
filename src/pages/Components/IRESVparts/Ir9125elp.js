...
const cardData = [
  {
    ...
    alt:      '  Crankshaft IR 9 1/2 x 5 ESV LUB Compressor Parts',
    heading:  '  Crankshaft IR 9 1/2 x 5 ESV LUB Compressor Parts',
  ...
  },
  {
    ...
    alt:  ' Valve Discharge IR 9 1/2 x 5 ESV LUB Parts',
    heading:  ' Valve Discharge IR 9 1/2 x 5 ESV LUB Parts',
  },

  {
    ...
    alt:     "  Valve Inlet IR 9 1/2 x 5 ESV LUB Compressor Parts",
    heading: '  Valve Inlet IR 9 1/2 x 5 ESV LUB Compressor Parts',
  },

  {
    ...
    alt:     "Compressor Parts List IR 9 1/2 x 5 ESV LUB Parts",
    heading: 'Compressor Parts List IR 9 1/2 x 5 ESV LUB Parts',
  ...
  },
  {
    ...
    alt:     "  Head Frame IR 9 1/2 x 5 ESV LUB Compressor Parts",
    heading: "  Head Frame IR 9 1/2 x 5 ESV LUB Compressor Parts",
  ...
  },
  {
    ...
    alt:     ' Plate Port Frame End IR 9 1/2 x 5 ESV LUB Parts',
    heading: "  Plate Port Frame End IR 9 1/2 x 5 ESV LUB Parts",

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt:     ' Lubricator 1 feed IR 9 1/2 x 5 ESV LUB Parts  ',
    heading: "Lubricator 1 feed IR 9 1/2 x 5 ESV LUB Parts",

  },
  
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt:     'Oil Pump Cover IR 9 1/2 x 5 ESV LUB Parts',
    heading: "Oil Pump Cover IR 9 1/2 x 5 ESV LUB Parts ",

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt:     'Suction Pipe IR 9 1/2 x 5 ESV LUB Compressor Parts',
    heading: " Suction Pipe IR 9 1/2 x 5 ESV LUB Compressor Parts",

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt:     '  Valve Inlet & Unloader IR 9 1/2 x 5 ESV LUB Parts ',
    heading: "  Valve Inlet & Unloader IR 9 1/2 x 5 ESV LUB Parts ",
  ...
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt:     ' Ingersoll Rand 9 1/2 x 5 LUB Air Compressor Parts ',
    heading: "  Ingersoll Rand 9 1/2 x 5 LUB Air Compressor Parts  ",
  ...
  return (
    ...
    <Grid className="home-container-page">
      ...
      <Grid item xs={12} className="home-page-textf">
        <h1><u>IR 9 1/2 x 5 ESV 1 LUB Parts</u></h1>
        <Grid item xs={12} md={6} className="mt-5">
        Ingersoll Rand 9 1/2 x 5 ESV 1 LUB Air Compressor Parts - Ingersoll Rand ESV Parts - Air Compressor Spare Parts
        </Grid>

        <Grid item xs={12} md={6} className="mt-4">PFC - parts for compressor is a Global Supplier of OEM quality new aftermarket replacement air compressor spare parts - Ingersoll Rand 9 1/2 x 5 ESV 1 LUB Air Compressor Parts - Ingersoll Rand ESV Parts from India.</Grid>
      </Grid>
