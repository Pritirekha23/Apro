...
const cardData = [
  {
    ...
    alt:      ' Rod Piston Complete IR 12 X 9 ESV 1 NL Compressor Parts',
    heading: ' Rod Piston Complete IR 12 X 9 ESV 1 NL Compressor Parts',
  ...
  },
  {
    ...
    alt:      ' Accessories IR 12 X 9 ESV 1 NL Compressor Parts',
    heading:  ' Accessories IR 12 X 9 ESV 1 NL Compressor Parts',
  },

  {
    ...
    alt:     " Frame & Gear Complete IR 12 X 9 ESV 1 NL Compressor Parts",
    heading: 'Frame & Gear Complete IR 12 X 9 ESV 1 NL Compressor Parts',
  },

  {
    ...
    alt:     "Cylinder Complete IR 12 X 9 ESV 1 NL Compressor Parts ",
    heading: 'Cylinder Complete IR 12 X 9 ESV 1 NL Compressor Parts',
  ...
  },
  {
    ...
    alt:     " Head Frame Complete IR 12 X 9 ESV 1 NL Compressor Parts",
    heading: "Head Frame Complete IR 12 X 9 ESV 1 NL Compressor Parts   ",
  ...
  },
  {
    ...
    alt:     ' Packing Metallic IR 12 X 9 ESV 1 NL Compressor Parts ',
    heading: "Packing Metallic IR 12 X 9 ESV 1 NL Compressor Parts",

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt:     'Valve Inlet Complete IR 12 X 9 ESV 1 NL Compressor Parts',
    heading: " Valve Inlet Complete IR 12 X 9 ESV 1 NL Compressor Parts",

  },
  
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt:     ' Head Outer Complete IR 12 X 9 ESV 1 NL Compressor Parts',
    heading: "Head Outer Complete IR 12 X 9 ESV 1 NL Compressor Parts",

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt:     '   Piston Complete IR 12 X 9 ESV 1 NL Compressor Parts ',
    heading: "   Piston Complete IR 12 X 9 ESV 1 NL Compressor Parts",

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt:     '  Valve Discharge Complete IR 12 X 9 ESV 1 NL Compressor Parts ',
    heading: " Valve Discharge Complete IR 12 X 9 ESV 1 NL Compressor Parts ",
  ...
  return (
    ...
    <Grid className="home-container-page">
      ...
      <Grid item xs={12} className="home-page-textf">
        <h1><u>IR 12 x 9 ESV 1 NL Parts</u></h1>
        <Grid item xs={12} md={6} className="mt-5">
        Ingersoll Rand 12 X 9 ESV NL Air Compressor Parts - Ingersoll Rand ESV Parts - Air Compressor Spare Parts
        </Grid>

        <Grid item xs={12} md={6} className="mt-4">PFC - parts for compressor is a Global Supplier of OEM quality new aftermarket replacement air compressor spare parts - Ingersoll Rand 12 X 9 ESV NL Air Compressor Parts - Ingersoll Rand ESV Parts from India.</Grid>
      </Grid>
