...
const cardData = [
  {
    ...
    alt: ' Inlet Filter IR 71T2 Air Compressor Parts',
    heading: '   Inlet Filter IR 71T2 Air Compressor Parts',
  ...
  },
  {
    ...
    alt: 'Overhaul Kit 32319642 IR 71T2 Replacement',
    heading: ' Overhaul Kit 32319642 IR 71T2 Replacement',
  },
  {
    ...
    alt: "Air Intercooler IR 71T2 Air Compressor Parts",
    heading: '  Air Intercooler IR 71T2 Air Compressor Parts',
  },

  {
    ...
    alt: " 35 GA Concentric Ring Valve Assly. IR 71T2 Parts",
    heading: '  35 GA Concentric Ring Valve Assly. IR 71T2 Parts',
  ...
  },
  {
    ...
    alt: "55 GA Concentric Ring Valve Assly. IR 71T2 Parts ",
    heading: " 55 GA Concentric Ring Valve Assly. IR 71T2 Parts",
  ...
  },
  {
    ...
    alt: ' Compressor Frame IR 71T2 Air Compressor Parts',
    heading: "  Compressor Frame IR 71T2 Air Compressor Parts",

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt: ' Ingersoll Rand Type 30 Model 71T2 Air Compressor Parts',
    heading: "Ingersoll Rand Type 30 Model 71T2 Air Compressor Parts",

  },

  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt: '  3" Piston & Cylinder IR 71T2 Air Compressor Parts',
    heading: ' 3" Piston & Cylinder IR 71T2 Air Compressor Parts',

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt: '  5 1/2" Piston & Cylinder IR 71T2 Compressor Parts',
    heading: ' 5 1/2" Piston & Cylinder IR 71T2 Compressor Parts',

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt: '  Valve Cylinder IR 71T2 Air Compressor Parts',
    heading: '  Valve Cylinder IR 71T2 Air Compressor Parts',
  ...
  return (
    ...
    <Grid className="home-container-page">
      ...
      <Grid item xs={12} className="home-page-textf">
        <h1><u>IR 71T2 Parts</u></h1>
        <Grid item xs={12} md={6} className="mt-5">
        PFC- Parts for compressor is a global supplier of OEM Quality New Aftermarket Replacement Air Compressor Spare Parts - Ingersoll Rand 71T2 Air Compressor Parts - Ingersoll Rand Type 30 Parts from India.
        </Grid>
      </Grid>
