...
const cardData = [
  {
    ...
    alt:    'Overhaul Kit 32305922 IR 234 Replacement',
    heading: 'Overhaul Kit 32305922 IR 234 Replacement',
  ...
  },
  {
    ...
    alt: 'Ingersoll Rand Type 30 Model 234 Air Compressor Parts',
    heading: ' Ingersoll Rand Type 30 Model 234 Air Compressor Parts',
  },
  {
    ...
    alt: "Pressure Controller IR 234 Air Compressor Parts",
    heading: ' Pressure Controller IR 234 Air Compressor Parts',
  },

  {
    ...
    alt: "  Compressor Frame IR 234 Air Compressor Parts",
    heading: ' Compressor Frame IR 234 Air Compressor Parts',
  ...
  },
  {
    ...
    alt: "Air Inlet Filter IR 234 Air Compressor Parts",
    heading: " Air Inlet Filter IR 234 Air Compressor Parts",
  ...
  },
  {
    ...
    alt: 'Compressor Drive - Air Receiver IR 234 Parts',
    heading: "Compressor Drive - Air Receiver IR 234 Parts",

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt: 'Cylinder and Piston IR 234 Air Compressor Parts',
    heading: " Cylinder and Piston IR 234 Air Compressor Parts ",
  ...
  return (
    ...
    <Grid className="home-container-page">
      ...
      <Grid item xs={12} className="home-page-textf">
        <h1><u>IR 234 Parts</u></h1>
        <Grid item xs={12} md={6} className="mt-5">PFC- Parts for compressor is a global supplier of OEM Quality New Aftermarket Replacement Air Compressor Spare Parts - Ingersoll Rand 234 Air Compressor Parts - Ingersoll Rand Type 30 Parts from India.
        </Grid>
      </Grid>
