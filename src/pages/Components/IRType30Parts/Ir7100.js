...
const cardData = [
  {
    ...
    alt: ' Second Stage Cylinder & Piston IR 7100 Parts',
    heading: ' Second Stage Cylinder & Piston IR 7100 Parts',
  ...
  },
  {
    ...
    alt: ' Overhaul Kit 32319485 IR 7100 Replacement',
    heading: ' Overhaul Kit 32319485 IR 7100 Replacement',
  },
  {
    ...
    alt: "  2nd Stage Valve Plate IR 7100 Compressor Parts",
    heading: '2nd Stage Valve Plate IR 7100 Compressor Parts',
  },

  {
    ...
    alt: " First Stage Cylinder & Piston IR 7100 Parts",
    heading: '  First Stage Cylinder & Piston IR 7100 Parts',
  ...
  },
  {
    ...
    alt: "First Stage Valve Plate IR 7100 Compressor Parts",
    heading: "First Stage Valve Plate IR 7100 Compressor Parts",
  ...
  },
  {
    ...
    alt: 'Intercooler & Shroud IR 7100 Air Compressor Parts',
    heading: "Intercooler & Shroud IR 7100 Air Compressor Parts",

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt: ' Compressor Frame IR 7100 Air Compressor Parts',
    heading: "  Compressor Frame IR 7100 Air Compressor Parts ",

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt: ' Bare Compressor IR 7100 Air Compressor Parts',
    heading: "Bare Compressor IR 7100 Air Compressor Parts ",

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt: 'Ingersoll Rand Type 30 Model 7100 Air Compressor Parts',
    heading: " Ingersoll Rand Type 30 Model 7100 Air Compressor Parts ",
  ...
  return (
    ...
    <Grid className="home-container-page">
      ...
      <Grid item xs={12} className="home-page-textf">
        <h1><u>IR 7100 Parts</u></h1>
        <Grid item xs={12} md={6} className="mt-5">Ingersoll Rand 7100 Air Compressor Parts - Ingersoll Rand Type 30 Parts - Air Compressor Spare Parts.
        </Grid>

        <Grid item xs={12} md={6} className="mt-4">PFC- Parts for compressor is a global supplier of OEM Quality New Aftermarket Replacement Air Compressor Spare Parts - Ingersoll Rand 7100 Air Compressor Parts - Ingersoll Rand Type 30 Parts from India.</Grid>
      </Grid>
