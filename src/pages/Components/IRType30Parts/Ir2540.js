...
const cardData = [
  {
    ...
    alt: 'LP Valve IR 2540 Air Compressor Parts',
    heading: 'LP Valve IR 2540 Air Compressor Parts',
  ...
  },
  {
    ...
    alt: 'Compressor Frame IR 2540 Air Compressor Parts',
    heading: ' Compressor Frame IR 2540 Air Compressor Parts',
  },
  {
    ...
    alt: "Ingersoll Rand Type 30 Model 2540 Air Compressor Parts",
    heading: ' Ingersoll Rand Type 30 Model 2540 Air Compressor Parts',
  },

  {
    ...
    alt: " Overhaul Kit 32319667 IR 2540 Replacement",
    heading: 'Overhaul Kit 32319667 IR 2540 Replacement',
  ...
  },
  {
    ...
    alt: " Intercooler IR 2540 Air Compressor Parts",
    heading: " Intercooler IR 2540 Air Compressor Parts",
  ...
  },
  {
    ...
    alt: 'HP Valve IR 2540 Air Compressor Parts',
    heading: "HP Valve IR 2540 Air Compressor Parts",

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt: 'Bare Compressor IR 2540 Air Compressor Parts',
    heading: " Bare Compressor IR 2540 Air Compressor Parts ",
  ...
  return (
    ...
    <Grid className="home-container-page">
      ...
      <Grid item xs={12} className="home-page-textf">
        <h1><u>IR 2540 Parts</u></h1>
        <Grid item xs={12} md={6} className="mt-5">
          Ingersoll Rand 2540 Air Compressor Parts - Ingersoll Rand Type 30 Parts - Air Compressor Spare Parts.
        </Grid>

        <Grid item xs={12} md={6} className="mt-4">PFC- Parts for compressor is a global supplier of OEM Quality New Aftermarket Replacement Air Compressor Spare Parts - Ingersoll Rand 2540 Air Compressor Parts - Ingersoll Rand Type 30 Parts from India.</Grid>
      </Grid>
