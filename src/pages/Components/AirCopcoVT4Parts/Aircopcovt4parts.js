          ...
          <Grid item xs={12} sm={6} md={4} key={index}>
            <Card sx={{ maxWidth: 345 }} className="card">
              <CardActionArea >
                ...
                <CardContent className=' p-3 bg-info text-dark ' >
              ...
              <CardActions>
                ...
                <Button  variant="contained"  color="error" className="btn btn-success" href="./assets/01_1203CompressorFrameAssembly-Model7T2.pdf">Download PDF</Button>     <ShareIcon />
              </CardActions>
            </Card>
          </Grid>
        ))}
