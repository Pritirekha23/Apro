...
const cardData = [
  {
    ...
    alt:   '  Discharge Valve Assembly HN2T 120-215 ',
    heading: ' Discharge Valve Assembly HN2T 120-215 ',
  ...
  },
  {
    ...
    alt:      ' Compressor Block HN2T 120-215 Parts' ,
    heading:  'Compressor Block HN2T 120-215 Parts',
  },
  {
    ...
    alt: ' Air Cylinder Assembly Dia. 320 HN2T 120-215',
    heading: ' Air Cylinder Assembly Dia. 320 HN2T 120-215',
  },

  {
    ...
    alt:  " Air Cylinder Assembly Dia. 370 HN2T 120-215",
    heading: 'Air Cylinder Assembly Dia. 370 HN2T 120-215',
  ...
  },
  {
    ...
    alt:  " Suction Valve and Cover Assembly HN2T 120-215",
    heading: " Suction Valve and Cover Assembly HN2T 120-215",
  ...
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt:  '  Piston Assembly Dia. 320 HN2T 120-215 ',
    heading: "  Piston Assembly Dia. 320 HN2T 120-215 ",

  },
  
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt:     '  Frame Assembly HN2T 120-215 Parts',
    heading: "   Frame Assembly HN2T 120-215 Parts",

  },
  {
    image: "https://static.wixstatic.com/media/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg/v1/fill/w_483,h_342,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/d7032a_c22fe4a4b172454b8ef25dd2ad4e9e06~mv2.jpg",
    alt:     '  Piston Assembly Dia. 370 HN2T 120-215  ',
    heading: "  Piston Assembly Dia. 370 HN2T 120-215 ",
  ...
  return (
    ...
    <Grid className="home-container-page">
      ...
      <Grid item xs={12} className="home-page-textf">
        <h1><u>HN2T 120-215 LP Parts</u></h1>
        <Grid item xs={12} md={6} className="mt-5">
        Chicago Pneumatic PET Compressor HN2T 120-215 LP Parts.
        </Grid>
        <Grid item xs={12} md={6} className="mt-5">
        Chicago Pneumatic HN2T 120-215 LP Parts - Chicago Pneumatic PET Compressor Parts - Air Compressor Spare Parts.
        </Grid>
        <Grid item xs={12} md={6} className="mt-4">PFC- Parts for compressor is a global supplier of OEM Quality New Aftermarket Replacement Air Compressor Spare Parts - Chicago Pneumatic HN2T 120-215 LP Parts - Chicago Pneumatic PET Compressor Parts from India.</Grid>
      </Grid>
          ...
          <Grid item xs={12} sm={6} md={4} key={index}>
            <Card sx={{ maxWidth: 345 }} className="card">
              <CardActionArea >
                ...
                <CardContent className=' p-3 bg-info text-dark '  style={{ borderRadius: '40px 0px 40px 0px ' }}>
