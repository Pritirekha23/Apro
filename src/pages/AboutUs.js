...
const AboutUS = () => {
  return (
    <Grid className="aboutus-page-main" style={{  marginTop: '8%' }}>
      ...
      <Typography className='aboutus-page-heading mt-4'>
      ...
      <Typography className='aboutus-page-heading '>PRODUCTS</Typography><br />
      <Typography >
      ...
      <Typography className='aboutus-page-heading '> SERVICES</Typography><br />
